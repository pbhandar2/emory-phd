...
def main():
    ...
    ax.plot(p, set1_df, '-o', label="20%", markersize=20, alpha=0.6)
    ...
    ax.plot(p, set2_df, '-*', label="10%", markersize=20, alpha=0.6)
    ...
    ax.plot(p, set3_df, '-^', label="10% + PP", markersize=20, alpha=0.6)
    ...
    ax.plot(p, set4_df, '-d', label="40%", markersize=20, alpha=0.6)
