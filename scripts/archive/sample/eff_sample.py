""" Generate a set of samples with various effective sampling rates.
"""

from argparse import ArgumentParser

from keyuri.config.BaseConfig import BaseConfig
from cydonia.blksample.sample import random_spatial_sampling, check_sample_set, DEFAULT_SAMPLING_RATE_ARR
...
def main():
    ...
    if check_sample_set(sample_output_dir_path, args.num_lower_order_bits_ignored, args.seed):
        print("The sample set with rates {}, bit {} and seed {} has already been generated in dir {}.".format(DEFAULT_SAMPLING_RATE_ARR, 
                                                                                                                args.num_lower_order_bits_ignored,
                                                                                                                args.seed,
                                                                                                                sample_output_dir_path))
    else:
