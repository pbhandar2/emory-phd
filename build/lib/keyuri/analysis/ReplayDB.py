...
Usage:
    db = ReplayDB("/path/to/replay/output/", "/path/to/replay/backup_output/")
    ...
    def delete_dead_experiments(
        ...
        for live_experiment_dir in live_experiment_arr:
            ...
            if host_name not in live_host_name_list:
                ...
                experiment_removed_arr.append(live_experiment_arr)
        return experiment_removed_arr
